...
type AgeRowWithStatus = {
    ...
    perTPStatus: Record<TpKey, StatusBreakdown>;
};
...
export default function UsiaPinjamanWithStatusTable({ year, tp }: Props) {
    ...
    useEffect(() => {
        ...
        const url = new URL('/api/pinjaman/analytics/usia-status', window.location.origin);
    ...
    return (
        <div className="space-y-2">
            <h3 className="font-semibold text-lg">Klasifikasi Usia Pinjaman per TP dengan Status</h3>
