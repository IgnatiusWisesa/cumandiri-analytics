...
export default function ProfesiKreditWithStatusTable({ year, tp }: Props) {
    ...
    useEffect(() => {
        ...
        const url = new URL('/api/kredit/analytics/profesi-tp-status', window.location.origin);
    ...
    return (
        <div className="space-y-2">
            <h3 className="font-semibold text-lg">Klasifikasi Profesi Kredit per TP dengan Status</h3>
